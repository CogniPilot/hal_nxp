...
#define HAS_QDEC DT_HAS_COMPAT_STATUS_OKAY(nxp_qdec_s32k)
...
#if DT_FOREACH_CHILD_STATUS_OKAY_VARGS(EMIOS_PWM_NODE(EMIOS_0_DRV_INST), \
                                       EMIOS_ICU_CHANNEL, 22) 0 || HAS_QDEC
...
#define EMIOS_ICU_CONFIG_SA_INIT_PB \
  extern const eMios_Icu_Ip_ChannelConfigType eMios_Icu_Ip_0_ChannelConfig_PB_Init[2U]; \
